                                ...
                                >
                                    {(provided, snapshot) => (
                                        <div
                                            ...
                                            className={`space-y-2 min-h-[160px] max-h-[calc(100vh-350px)] overflow-y-auto overflow-x-hidden scroll-smooth ${snapshot.isDraggingOver ? "bg-blue-50 dark:bg-blue-900/20" : ""}`}
                                        >
                                            {subcolumnCards.map(
                                                (card, index) => (
                                                    <Draggable
        ...
        return (
            <div className="flex gap-2">
                ...
                <div className="flex flex-col w-56 h-fit scroll-smooth bg-white dark:bg-gray-900 rounded-b-lg pb-5">
                    ...
                    <div className="px-3 space-y-2 min-h-[160px] max-h-[calc(100vh-350px)] overflow-y-auto overflow-x-hidden scroll-smooth">
