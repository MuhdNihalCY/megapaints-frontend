...
class InventoryService {
  ...
  async getProductInventory(branchId, productId) {
    try {
      const response = await this.adminApi.apiRequest(`/admin/inventory/${branchId}/${productId}`, {
        method: 'GET'
      });
  ...
  async createInventory(data) {
    try {
      const response = await this.adminApi.apiRequest('/admin/inventory', {
        method: 'POST',
  ...
  async bulkUpdateInventory(updates) {
    try {
      const response = await this.adminApi.apiRequest('/admin/inventory/bulk-update', {
        method: 'POST',
        body: JSON.stringify({ updates }),
        headers: {
          'Content-Type': 'application/json'
  ...
  async addStock(branchId, productId, quantity, metadata = {}) {
    try {
      const response = await this.adminApi.apiRequest(`/admin/inventory/${branchId}/${productId}/add`, {
        method: 'POST',
        body: JSON.stringify({
          quantity,
          ...metadata
  ...
  async deductStock(branchId, productId, quantity, metadata = {}) {
    try {
      const response = await this.adminApi.apiRequest(`/admin/inventory/${branchId}/${productId}/deduct`, {
        method: 'POST',
        body: JSON.stringify({
          quantity,
          ...metadata
  ...
  async syncInventory(options = {}) {
    try {
      const response = await this.adminApi.apiRequest('/admin/inventory/sync', {
        method: 'POST',
        body: JSON.stringify({
  ...
  async resolveConflict(conflictId, resolution, resolutionData = {}) {
    try {
      const response = await this.adminApi.apiRequest('/admin/inventory/sync/resolve', {
        method: 'POST',
        body: JSON.stringify({
