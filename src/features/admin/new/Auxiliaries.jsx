...
const Auxiliaries = () => {
    ...
    const handleSubmit = async () => {
        try {
            if (editingAuxiliary) {
                ...
                setSnackbar({
                    open: true,
                    message: "Auxiliary added successfully",
                    severity: "success",
                });
            }
            ...
            setSnackbar({
                open: true,
                message: "Failed to save auxiliary",
                severity: "error",
            });
    ...
    const handleDeleteAuxiliary = async (id) => {
        const confirmDelete = window.confirm(
            "Are you sure you want to delete this auxiliary?",
        );
        ...
        try {
            ...
            setSnackbar({
                open: true,
                message: "Auxiliary deleted successfully",
                severity: "success",
            });
        } catch (err) {
            setSnackbar({
                open: true,
                message: "Failed to delete auxiliary",
                severity: "error",
            });
                            ...
                            <TableRow key={auxiliary.id}>
                                ...
                                <TableCell>
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            handleDeleteAuxiliary(auxiliary.id)
                                        }
                                    >
                                        Delete
                                    </Button>
