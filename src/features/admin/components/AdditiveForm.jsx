    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (additive) {
                ...
                response = await adminServices.productCatalog.updateAdditive(
                    additive._id,
                    submitData,
                );
            } else {
                // Create new additive
                response =
                    await adminServices.productCatalog.createAdditive(
                        submitData,
                    );
            }
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                {additive
                                    ? "Update additive information"
                                    : "Create a new paint additive"}
                            </p>
                        </div>
                    </div>
                    <button
