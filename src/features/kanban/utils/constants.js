...
export const DND_RESTRICTIONS = {
  // Columns that cannot receive cards from other columns
  RESTRICTED_COLUMNS: [DONE_SUBCOLUMNS.LESS_THAN_7_DAYS, DONE_SUBCOLUMNS.MORE_THAN_7_DAYS],
  // Columns that cannot send cards to other columns
  RESTRICTED_SOURCE_COLUMNS: [DONE_SUBCOLUMNS.LESS_THAN_7_DAYS, DONE_SUBCOLUMNS.MORE_THAN_7_DAYS],
  // Allowed moves between main columns (excluding Done subcolumns)
  ALLOWED_MOVES: {
    [COLUMN_TYPES.SALES]: [COLUMN_TYPES.OFFICE, COLUMN_TYPES.PRODUCTION, COLUMN_TYPES.READY, COLUMN_TYPES.DRIVERS, DONE_SUBCOLUMNS.DONE_TODAY],
    [COLUMN_TYPES.OFFICE]: [COLUMN_TYPES.SALES, COLUMN_TYPES.PRODUCTION, COLUMN_TYPES.READY, COLUMN_TYPES.DRIVERS, DONE_SUBCOLUMNS.DONE_TODAY],
    [COLUMN_TYPES.PRODUCTION]: [COLUMN_TYPES.SALES, COLUMN_TYPES.OFFICE, COLUMN_TYPES.READY, COLUMN_TYPES.DRIVERS, DONE_SUBCOLUMNS.DONE_TODAY],
    [COLUMN_TYPES.READY]: [COLUMN_TYPES.SALES, COLUMN_TYPES.OFFICE, COLUMN_TYPES.PRODUCTION, COLUMN_TYPES.DRIVERS, DONE_SUBCOLUMNS.DONE_TODAY],
    [COLUMN_TYPES.DRIVERS]: [COLUMN_TYPES.SALES, COLUMN_TYPES.OFFICE, COLUMN_TYPES.PRODUCTION, COLUMN_TYPES.READY, DONE_SUBCOLUMNS.DONE_TODAY],
    [DONE_SUBCOLUMNS.DONE_TODAY]: [COLUMN_TYPES.SALES, COLUMN_TYPES.OFFICE, COLUMN_TYPES.PRODUCTION, COLUMN_TYPES.READY, COLUMN_TYPES.DRIVERS]
  }
};
