...
export const AuthProvider = ({ children }) => {
                ...
                if (hasTokens) {
                    ...
                    if (currentUser) {
                        ...
                        try {
                            ...
                            console.warn(
                                "⚠️ Session validation failed, but keeping user logged in:",
                                error.message,
                            );
                        ...
                        console.log(
                            "❌ No user found in localStorage, checking tokens...",
                        );
                        ...
                        try {
                            ...
                            if (
                                ...
                                console.log(
                                    "🔒 Clearing tokens due to auth error",
                                );
                                setUser(null);
                                setIsAdmin(false);
                                authService.clearTokens();
    ...
    const value = {
        ...
        hasPermission: (permission) =>
            apiServiceFactory.hasPermission(permission),
        hasAnyPermission: (permissions) =>
            apiServiceFactory.hasAnyPermission(permissions),
        hasAllPermissions: (permissions) =>
            apiServiceFactory.hasAllPermissions(permissions),
    };
