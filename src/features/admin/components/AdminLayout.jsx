...
const menuItems = [
  ...
  { text: 'Auxiliaries', icon: PuzzlePiece, path: '/admin/auxiliaries' },
  { text: 'Accessories', icon: PuzzlePiece, path: '/admin/accessories' },
...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out z-30 ${
          open ? 'w-64' : 'w-20'
        }`}
      >
        {/* Logo Section */}
          ...
          <div className="px-2 space-y-1">
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-5 h-5 ${open ? 'mr-3' : ''} ${isActive ? 'text-blue-600 dark:text-blue-400' : ''}`} />
                  {open && (
