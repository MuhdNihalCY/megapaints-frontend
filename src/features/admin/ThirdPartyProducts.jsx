                ...
                filteredAndSortedThirdPartyProducts.map((thirdPartyProduct) => (
                  <tr key={thirdPartyProduct._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                      ...
                      <div className="flex items-center">
                        <div className="min-w-0">
                          ...
                          <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 truncate">
                            ID: {thirdPartyProduct._id?.toString().slice(-8) || thirdPartyProduct.id}
                          </div>
                    ...
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white hidden md:table-cell">
                      <div className="truncate block max-w-[150px]">{thirdPartyProduct.supplier?.name || thirdPartyProduct.supplier_name || '-'}</div>
                    ...
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white hidden lg:table-cell">
                      <div className="flex items-center">
                        <span className="font-semibold">AED {thirdPartyProduct.unit_price?.toFixed(2) || '0.00'}</span>
