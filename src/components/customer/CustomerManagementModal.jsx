...
const CustomerManagementModal = ({
    ...
    mode = "manage",
    onCustomerCreated,
    editingCustomer: externalEditingCustomer = null,
    onCustomerUpdated,
    autoShowCreateForm = false,
}) => {
    ...
    const [showCreateForm, setShowCreateForm] = useState(
        mode === "create-only" || autoShowCreateForm,
    ); // Auto-show create form in create-only mode or if autoShowCreateForm is true
    const [showEditForm, setShowEditForm] = useState(
        mode === "edit-only" || !!externalEditingCustomer,
    ); // Auto-show edit form in edit-only mode or if editingCustomer prop provided
    const [editingCustomer, setEditingCustomer] = useState(
        externalEditingCustomer,
    );
    ...
    const loadCustomers = async () => {
        ...
        try {
            ...
            if (
                ...
                setError(
                    "No branch assigned to your account. Please contact an administrator to assign a branch before accessing customers.",
                );
                setCustomers([]);
                setLoading(false);
                return;
            ...
            const errorResponse =
                originalError?.response?.data || err.response?.data;
            const errorMessage =
            ...
            if (
                ...
                if (
                    ...
                    setError(
                        "Branch ID is required to access customers. Please contact support if this issue persists.",
                    );
                }
            } else {
    ...
    const handleCreateCustomer = async (e) => {
        ...
        if (!branchId) {
            setCreateError(
                "No branch assigned to your account. Please contact an administrator to assign a branch before creating customers.",
            );
            return;
        }
        ...
        try {
            ...
            const transformedContacts = (newCustomer.contacts || [])
                .map((contact) => {
                    const phone =
                    ...
                    if (contact.use_same_as_phone) {
                        ...
                        whatsappNumber =
                            `${contact.whatsapp_country_code}${contact.whatsapp_number}`.trim();
                    }
                ...
                ); // Only include contacts that have at least one field filled
            ...
            const customerData = {
                ...
                address: {
                    ...
                    city:
                        newCustomer.location?.trim() ||
                        newCustomer.address?.city?.trim() ||
                        undefined,
                },
            ...
            if (
                ...
                errorDetails.some(
                    (d) => typeof d === "string" && d.includes("Branch"),
                )
            ) {
                setCreateError(
                    "Branch ID is required. Please contact support if this issue persists.",
                );
            } else {
                setCreateError(
                    errorMessage ||
    ...
    const handleUpdateCustomer = async (e) => {
        ...
        try {
            ...
            const transformedContacts = (editingCustomer.contacts || [])
                .map((contact) => {
                    const phone =
                        contact.phone_country_code && contact.phone_number
                            ? `${contact.phone_country_code}${contact.phone_number}`.trim()
            ...
            const updateData = {
                ...
                address: {
                    street:
                        editingCustomer.address?.street?.trim() || undefined,
                    city:
                        editingCustomer.location?.trim() ||
                        editingCustomer.address?.city?.trim() ||
                        undefined,
                },
                sales_executive:
                    editingCustomer.sales_executive?.trim() || null,
            ...
            const response = await kanbanService.updateCustomer(
                editingCustomer._id,
                updateData,
            );
    ...
    const handleEditCustomer = (customer) => {
        ...
        const transformedContacts = (customer.contacts || []).map((contact) => {
            ...
            if (contact.position && contact.position.includes("WhatsApp:")) {
                const whatsappMatch = contact.position.match(
                    /WhatsApp:\s*(\+\d{1,4})(\d+)/,
                );
                if (whatsappMatch) {
        ...
        setEditingCustomer({
            ...
            sales_executive:
                customer.sales_executive?._id || customer.sales_executive || "",
            coordinator:
                customer.coordinator?._id || customer.coordinator || "",
            ...
            <>
                ...
                <form onSubmit={handleUpdateCustomer} className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    value={
                                        editingCustomer.sales_executive || ""
                                    }
                                    onChange={(e) =>
                                        setEditingCustomer((prev) => ({
                                            ...prev,
                    ...
                    <div className="space-y-4">
                        ...
                        editingCustomer.contacts.length === 0 ? (
                                                ...
                                                <div>
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex items-center gap-2 mb-2">
                                                            ...
                                                            />
                                                            <label
                                                                htmlFor={`edit-same-as-phone-${index}`}
            ...
            >
                ...
                >
                                                    ...
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <div className="flex items-center gap-2 mt-1">
                                                                ...
                                                                <span
                                                                    className={`text-xs px-2 py-1 rounded ${getTypeColor(customer.customer_type)}`}
                                                                >
                                                                    {
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center gap-2 mt-2">
                                                        <span
                                                            className={`text-sm px-3 py-1 rounded-full ${getStatusColor(selectedCustomer.status)}`}
                                                        >
                                                            {
                                                        ...
                                                        <span
                                                            className={`text-sm px-3 py-1 rounded-full ${getTypeColor(selectedCustomer.customer_type)}`}
                                                        >
                                                            {
                                                    ...
                                                    <div className="space-y-2 text-sm">
                                                        ...
                                                        {selectedCustomer
                                                            ...
                                                            <div className="text-gray-600 dark:text-gray-400">
                                                                ...
                                                                $
                                                                {selectedCustomer.business_info.annual_revenue.toLocaleString()}
                                                            </div>
                                                        )}
                                                        {selectedCustomer
                                                            .business_info
                                                            ...
                                                            <div className="text-gray-600 dark:text-gray-400">
                                                                ...
                                                                {selectedCustomer.business_info.employee_count.toLocaleString()}
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="space-y-2 text-sm">
                                                        {selectedCustomer.sales_executive && (
                                                            <div className="text-gray-600 dark:text-gray-400">
                                                                ...
                                                                {typeof selectedCustomer.sales_executive ===
                                                                "object"
                                                                    ? selectedCustomer
                                                                          .sales_executive
                                                                          .name ||
                                                        ...
                                                        {selectedCustomer.coordinator && (
                                                            <div className="text-gray-600 dark:text-gray-400">
                                                                ...
                                                                {typeof selectedCustomer.coordinator ===
                                                                "object"
                                                                    ? selectedCustomer
                                                                          .coordinator
                                                                          .name ||
                                                        ...
                                                        {selectedCustomer.branch_id && (
                                                            <div className="text-gray-600 dark:text-gray-400">
                                                                ...
                                                                {typeof selectedCustomer.branch_id ===
                                                                "object"
                                                                        ...
                                                                        <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                                                                            ...
                                                                            {project.actual_value && (
                                                                                <div>
                                                                                    ...
                                                                                    <span className="font-medium">
                                                                                        $
                                                                                        {project.actual_value.toLocaleString()}
                                                                                    </span>
                                                                                </div>
                                                                            )}
                                                                            {project.start_date && (
                                            ...
                                            <div className="space-y-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                                                ...
                                                {selectedCustomer.created_by && (
                                                    <div className="text-sm text-gray-500 dark:text-gray-400">
                                                        ...
                                                        {typeof selectedCustomer.created_by ===
                                                        "object"
                                                            ? selectedCustomer
                                                                  .created_by
                                                                  .name ||
                    ...
                    {(showCreateForm || mode === "create-only") &&
                        (mode ===
                        "create-only" ? // We'll render the actual form content there // In create-only mode, form is already rendered in the div above (line 725-736)
                        null : (
                            <AnimatePresence>
                                {showCreateForm && (
