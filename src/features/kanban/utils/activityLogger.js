 ...
 */
export const createActivityLog = (type, userId, cardId, data = {}, before = null, after = null) => {
  return {
    type,
    userId,
    cardId,
 ...
 * Log card move
 */
export const logCardMoved = (card, user, fromColumn, toColumn, fromSubColumn, toSubColumn) => {
  return createActivityLog(
...
export const exportActivitiesToCSV = (activities, users) => {
  const headers = ['Timestamp', 'User', 'Type', 'Description', 'Card ID', 'Metadata'];
