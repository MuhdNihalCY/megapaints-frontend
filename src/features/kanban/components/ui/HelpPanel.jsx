...
const HelpPanel = () => {
    ...
    const features = [
        {
            title: "Inline Card Creation",
            description: 'Click "Add card" to create cards directly in columns',
        },
        {
            title: "Drag & Drop",
            description: "Drag cards between columns to move them",
        },
        {
            title: "Quick Actions",
            description: "Hover over cards to see quick action buttons",
        },
        {
            title: "Priority Indicators",
            description: "Cards show priority levels with color coding",
        },
        {
            title: "Due Date Tracking",
            description: "Cards with due dates show status indicators",
        },
        {
            title: "Labels & Assignees",
            description: "Add labels and assign team members to cards",
        },
        {
            title: "Comments & Attachments",
            description: "Add comments and attachments to cards",
        },
        {
            title: "Filtering",
            description:
                "Filter cards by priority, labels, assignees, and due dates",
        },
    ];
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(80vh-120px)]">
                    ...
                    <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        ...
                        <ul className="text-xs text-blue-800 dark:text-blue-200 space-y-1">
                            ...
                            <li>
                                • Drag cards between columns to update their
                                status
                            </li>
                            <li>
                                • Add labels and assignees during card creation
                            ...
                            <li>
                                • Set due dates to track deadlines and get
                                visual reminders
                            </li>
                        </ul>
                    </div>
