...
const ProductForm = ({ product = null, defaultProductType = null, onClose, onSuccess }) => {
  ...
  const validateForm = () => {
    ...
    if (formData.volume && parseFloat(formData.volume) < 0) {
      errors.volume = 'Volume must be non-negative';
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2 pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Category & Type</h3>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2 pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Physical Properties</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center">
                  ...
                  <input
                    ...
                    step="0.001"
                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-colors ${
                      validationErrors.weight ? 'border-red-500 bg-red-50 dark:bg-red-900/10' : 'border-gray-300'
                    }`}
                    placeholder="0.000"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.001"
                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-colors ${
                      validationErrors.volume ? 'border-red-500 bg-red-50 dark:bg-red-900/10' : 'border-gray-300'
                    }`}
                    placeholder="0.000"
                  />
