    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (thirdPartyProduct) {
                ...
                response =
                    await adminServices.productCatalog.updateThirdPartyProduct(
                ...
                response =
                    await adminServices.productCatalog.createThirdPartyProduct(
                        submitData,
                    );
            }
            ...
            if (response.status === "success") {
                setSuccess(
                    thirdPartyProduct
                        ? "Third party product updated successfully!"
                        : "Third party product created successfully!",
                );
                setTimeout(() => {
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                                {thirdPartyProduct
                                    ? "Edit Third Party Product"
                                    : "Add New Third Party Product"}
                            </h2>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                {thirdPartyProduct
                                    ? "Update third party product information"
