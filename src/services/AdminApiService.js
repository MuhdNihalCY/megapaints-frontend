...
class AdminApiService {
    ...
    async logout() {
        try {
            return await this.apiRequest("/auth/admin/logout", {
                method: "POST",
            });
        } catch (error) {
    ...
    async getCategories(params = {}) {
        ...
        return await this.apiRequest(
            `/admin/products/categories?${queryString}`,
        );
    }
    ...
    async getAdditives(params = {}) {
        ...
        return await this.apiRequest(
            `/admin/products/additives?${queryString}`,
        );
    }
    ...
    async updateAdditive(additiveId, additiveData) {
        return await this.apiRequest(
            `/admin/products/additives/${additiveId}`,
            {
                method: "PUT",
                body: JSON.stringify(additiveData),
            },
    ...
    async getAuxiliaries(params = {}) {
        ...
        return await this.apiRequest(
            `/admin/products/auxiliaries?${queryString}`,
        );
    }
    ...
    async updateAuxiliary(auxiliaryId, auxiliaryData) {
        return await this.apiRequest(
            `/admin/products/auxiliaries/${auxiliaryId}`,
            {
                method: "PUT",
                body: JSON.stringify(auxiliaryData),
            },
    ...
    async getAccessories(params = {}) {
        ...
        return await this.apiRequest(
            `/admin/products/accessories?${queryString}`,
        );
    }
    ...
    async updateAccessory(accessoryId, accessoryData) {
        return await this.apiRequest(
            `/admin/products/accessories/${accessoryId}`,
            {
                method: "PUT",
                body: JSON.stringify(accessoryData),
            },
    ...
    async getThirdPartyProducts(params = {}) {
        ...
        return await this.apiRequest(
            `/admin/products/third-party?${queryString}`,
        );
    }
    ...
    async updateThirdPartyProduct(thirdPartyId, thirdPartyData) {
        return await this.apiRequest(
            `/admin/products/third-party/${thirdPartyId}`,
            {
                method: "PUT",
                body: JSON.stringify(thirdPartyData),
            },
    ...
    async getAllItems(params = {}) {
        ...
        return await this.apiRequest(
            `/admin/products/all-items?${queryString}`,
        );
    }
    ...
    async getBoardsByBranch(branchId) {
        return await this.apiRequest(
            `/board/v2/board/branch?branchId=${branchId}`,
        );
    }
