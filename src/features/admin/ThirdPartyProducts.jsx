...
const ThirdPartyProducts = () => {
    ...
    const [editingThirdPartyProduct, setEditingThirdPartyProduct] =
        useState(null);
    ...
    const handleDeleteThirdPartyProduct = async (thirdPartyProduct) => {
        if (
            !window.confirm(
                `Are you sure you want to delete third party product "${thirdPartyProduct.name}"? This action cannot be undone.`,
            )
        ) {
            return;
        }
                        ...
                        <div className="overflow-hidden">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    {filteredAndSortedThirdPartyProducts.length ===
                                    0 ? (
                                        <tr>
                                            <td
                                                colSpan="5"
                                        ...
                                        filteredAndSortedThirdPartyProducts.map(
                                            (thirdPartyProduct) => (
                                                <tr
