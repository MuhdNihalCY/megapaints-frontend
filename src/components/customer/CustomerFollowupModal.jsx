...
const CustomerFollowupModal = ({ isOpen, onClose, user, mode = "manage" }) => {
    ...
    const handleCreateFollowup = async () => {
        if (
            !newFollowup.customer_id ||
            !newFollowup.subject.trim() ||
            !newFollowup.followup_date
        ) {
            setCreateError(
                "Customer, subject, and follow-up date are required",
            );
            return;
        }
    ...
    const handleUpdateFollowup = async () => {
        ...
        try {
            const response = await api.put(
                `/customer-followups/${editingFollowup._id}`,
                editingFollowup,
            );
                            ...
                            <div className="space-y-3">
                                {followups.map((followup) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`px-2 py-1 text-xs rounded-full ${getPriorityColor(followup.priority)}`}
                                                >
                                                    {followup.priority}
                                                </span>
                                                <span
                                ...
                                {followups.length === 0 && !loading && (
                                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                                        ...
                                        <p className="text-sm">
                                            Create your first follow-up to get
                                            started
                                        </p>
                                    </div>
                                )}
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                                        ...
                                        <strong>{deleteConfirm.subject}</strong>
