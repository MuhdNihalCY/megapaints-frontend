...
export const testCardUpdate = async (
    cardId,
    updates,
    expectedResult = true,
) => {
...
export const testCardMove = async (
    cardId,
    toColumnId,
    expectedResult = true,
) => {
...
export const testColumnActivation = async (
    columnId,
    isActive,
    expectedResult = true,
) => {
...
export const testCommentAddition = async (
    cardId,
    commentData,
    expectedResult = true,
) => {
...
export const testAccessibility = (component) => {
    ...
    const elementsWithAria = component.querySelectorAll(
