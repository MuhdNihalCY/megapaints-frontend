  ...
  useEffect(() => {
    const fetchBranches = async () => {
      try {
        ...
        const mockData = [
          { id: 'BR001', name: 'Main Branch', location: 'Downtown', contact: '+1234567890', manager: 'John Doe' },
          { id: 'BR002', name: 'North Branch', location: 'Northside', contact: '+1234567891', manager: 'Jane Smith' }
        ];
