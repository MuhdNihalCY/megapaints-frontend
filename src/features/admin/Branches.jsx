...
const Branches = () => {
    ...
    const fetchBranches = async () => {
        try {
            ...
            const response =
                await adminServices.businessManagement.getBranches(params);
    ...
    const handleDeleteBranch = async (branch) => {
        ...
        try {
            const adminServices = getAdminServices();
            const response =
                await adminServices.businessManagement.deleteBranch(branch._id);
    ...
    const filteredAndSortedBranches = useMemo(() => {
        ...
        if (filterActive !== null) {
            filtered = filtered.filter(
                (branch) => branch.is_active === filterActive,
            );
        }
