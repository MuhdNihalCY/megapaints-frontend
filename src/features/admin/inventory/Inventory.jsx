...
const Inventory = () => {
    ...
    const fetchInventory = async () => {
        try {
            ...
            const response =
                await adminServices.inventoryManagement.getInventory(params);
    ...
    const handleDeleteInventory = async (inventory) => {
        ...
        try {
            ...
            const response =
                await adminServices.inventoryManagement.deleteInventory(
                    String(branchId),
                    String(productId),
                );
    ...
    const filteredAndSortedInventories = useMemo(() => {
        ...
        if (searchTerm) {
            ...
            filtered = filtered.filter(
                (inv) =>
                    ...
                    (inv.product?.code &&
                        inv.product.code.toLowerCase().includes(searchLower)) ||
                    (inv.branch?.name &&
                        inv.branch.name.toLowerCase().includes(searchLower)),
            );
        }
        ...
        if (selectedBranch) {
            filtered = filtered.filter((inv) => {
                ...
                return (
                    ...
                    branchId?.toString() === selectedBranch
                );
            });
        }
        ...
        if (selectedProductType) {
            filtered = filtered.filter(
                (inv) => inv.product?.product_type === selectedProductType,
            );
        }
        ...
        <div className="space-y-6">
            ...
            {activeTab === "stock-update" ? (
                <div className="p-8 text-center text-gray-500">
                    Bulk stock update is currently disabled.
                </div>
            ) : (
                <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    console.log(
                                        "[Inventory] Product type filter changed:",
                                        {
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    {filteredAndSortedInventories.length ===
                                    0 ? (
                                        <tr>
                                            <td
                                                colSpan="5"
                                        ...
                                        filteredAndSortedInventories.map(
                                            (inventory, index) => {
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <div className="text-sm text-gray-900 dark:text-white">
                                                                <div className="font-semibold">
                                                                    {stockInfo.current_stock?.toFixed(
                                                                        3,
                                                                    ) ||
                                                                        "0.000"}{" "}
                                                                    {stockInfo.unit ||
                                                                ...
                                                                <div className="text-xs text-gray-500 dark:text-gray-400">
                                                                    Min:{" "}
                                                                    {stockInfo.minimum_stock?.toFixed(
                                                                        3,
                                                                    ) ||
                                                                        "0.000"}{" "}
                                                                    | Max:{" "}
                                                                    {stockInfo.maximum_stock?.toFixed(
                                                                        3,
                                                                    ) ||
                                                                        "0.000"}
                                                                </div>
