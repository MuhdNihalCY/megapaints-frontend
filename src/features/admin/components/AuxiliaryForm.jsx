    ...
    useEffect(() => {
        if (auxiliary) {
            setFormData({
                ...
                type: auxiliary.type || "",
                properties:
                    typeof auxiliary.properties === "object"
                        ? JSON.stringify(auxiliary.properties)
                        : auxiliary.properties || "",
                base_price: auxiliary.unit_price || "",
                unit: auxiliary.unit || "kg",
                is_active:
                    auxiliary.is_active !== undefined
                        ? auxiliary.is_active
                        : true,
            });
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (auxiliary) {
                ...
                response = await adminServices.productCatalog.updateAuxiliary(
                    auxiliary._id,
                    submitData,
                );
            } else {
                ...
                response =
                    await adminServices.productCatalog.createAuxiliary(
                        submitData,
                    );
            }
            ...
            if (response.status === "success") {
                setSuccess(
                    auxiliary
                        ? "Auxiliary updated successfully!"
                        : "Auxiliary created successfully!",
                );
                setTimeout(() => {
