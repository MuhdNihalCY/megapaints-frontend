                ...
                <div className="ml-3 flex-1">
                    ...
                    <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                        ...
                        <ul className="mt-2 list-disc list-inside space-y-1">
                            {apiStatus.boardManagement === "mock" && (
                                <li>
                                    Board Management (Kanban boards, columns,
                                    cards)
                                </li>
                            )}
                            {apiStatus.labelManagement === "mock" && (
                                <li>
                                    Label Management (labels, categories,
                                    colors)
                                </li>
                            )}
                        </ul>
                        <p className="mt-2">
                            All data is stored locally and will be lost on page
                            refresh. This is normal behavior for development
                            mode.
                        </p>
                    </div>
                </div>
