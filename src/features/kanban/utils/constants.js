...
export const CARD_LABELS = {
  ...
  FEATURE: { id: 'feature', name: 'Feature', color: '#3B82F6', textColor: '#FFFFFF' },
  TASK: { id: 'task', name: 'Task', color: '#10B981', textColor: '#FFFFFF' },
  URGENT: { id: 'urgent', name: 'Urgent', color: '#F59E0B', textColor: '#000000' },
  REVIEW: { id: 'review', name: 'Review', color: '#8B5CF6', textColor: '#FFFFFF' },
  BLOCKED: { id: 'blocked', name: 'Blocked', color: '#6B7280', textColor: '#FFFFFF' }
};
...
export const PERMISSION_MATRIX = {
  VIEW_BOARD: [USER_ROLES.SALES, USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER, USER_ROLES.DRIVER_LEAD, USER_ROLES.OFFICE, USER_ROLES.ADMIN],
  CREATE_CARD: [USER_ROLES.SALES, USER_ROLES.SALES_LEAD, USER_ROLES.ADMIN],
  EDIT_CARD: [USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER_LEAD, USER_ROLES.ADMIN],
  MOVE_CARD: [USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER_LEAD, USER_ROLES.ADMIN],
  ASSIGN_USERS: [USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER_LEAD, USER_ROLES.ADMIN],
  CHANGE_DUE: [USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER_LEAD, USER_ROLES.ADMIN],
  CHANGE_LABELS: [USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER_LEAD, USER_ROLES.ADMIN],
  MANAGE_COLUMNS: [USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER_LEAD, USER_ROLES.ADMIN],
  COMMENT: [USER_ROLES.SALES, USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER, USER_ROLES.DRIVER_LEAD, USER_ROLES.OFFICE, USER_ROLES.ADMIN],
  MENTION: [USER_ROLES.SALES, USER_ROLES.SALES_LEAD, USER_ROLES.PRODUCTION, USER_ROLES.PRODUCTION_LEAD, USER_ROLES.DRIVER, USER_ROLES.DRIVER_LEAD, USER_ROLES.OFFICE, USER_ROLES.ADMIN]
};
