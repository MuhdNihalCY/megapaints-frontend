...
const Additives = () => {
    ...
    const handleDeleteAdditive = async (additive) => {
        if (
            !window.confirm(
                `Are you sure you want to delete additive "${additive.name}"? This action cannot be undone.`,
            )
        ) {
            return;
        }
    ...
    const filteredAndSortedAdditives = useMemo(() => {
        ...
        if (filterActive !== null) {
            filtered = filtered.filter(
                (additive) => additive.is_active === filterActive,
            );
        }
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    {filteredAndSortedAdditives.length === 0 ? (
                                        ...
                                        filteredAndSortedAdditives.map(
                                            (additive) => (
                                                <tr
                                                    key={additive._id}
