...
class ProductCatalogService {
    ...
    async updateThirdPartyProduct(thirdPartyId, thirdPartyData) {
        return await this.adminApi.updateThirdPartyProduct(
            thirdPartyId,
            thirdPartyData,
        );
    }
        ...
        try {
            ...
            switch (itemType) {
                ...
                case "binder":
                    ...
                    break;
                case "auxiliary":
                    items = await this.getAuxiliaries({
                        limit: 1000,
                        ...options,
                    });
                    break;
                case "accessory":
                    items = await this.getAccessories({
                        limit: 1000,
                        ...options,
                    });
                    break;
                case "third_party":
                    items = await this.getThirdPartyProducts({
                        limit: 1000,
                        ...options,
                    });
                    break;
