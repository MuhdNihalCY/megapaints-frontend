  ...
  const handleSubmit = async () => {
    try {
      if (editingCategory) {
        ...
        const response = await apiRequest(`/v1/category/${editingCategory._id}`, {
          method: 'PUT',
        ...
        {categories.length === 0 ? (
          ...
          <Card 
            sx={{ 
              ...
              border: theme => `1px dashed ${theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0, 0, 0, 0.1)'}`,
              borderRadius: 2
            }}
          >
            <CardContent>
          ...
          <TableContainer component={Paper}>
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: theme => theme.palette.mode === 'dark' ? 'rgba(0, 0, 0, 0.1)' : 'rgba(0, 0, 0, 0.02)' }}>
              ...
              <TableBody>
                {categories.map((category) => (
                  <TableRow 
                    ...
                    sx={{ 
                      '&:hover': { 
                        backgroundColor: theme => theme.palette.mode === 'dark' ? 'rgba(0, 0, 0, 0.05)' : 'rgba(0, 0, 0, 0.03)' 
                      } 
                    }}
                  >
                    <TableCell>{category._id}</TableCell>
                    <TableCell>{category.name || category.Category || 'N/A'}</TableCell>
                    <TableCell align="right">
                      <IconButton 
                        ...
                        sx={{ 
                          color: 'primary.main',
                          '&:hover': {
                            backgroundColor: theme => theme.palette.mode === 'dark' ? 'rgba(0, 0, 0, 0.1)' : 'rgba(0, 0, 0, 0.05)'
                          }
                        }}
                      >
                        <EditIcon />
