...
const SubCategories = () => {
    ...
    useEffect(() => {
        console.log(
            "[SubCategories] State change - subCategories count:",
    ...
    useEffect(() => {
        console.log(
            "[SubCategories] State change - categories count:",
            categories.length,
        );
    }, [categories.length]);
    ...
    useEffect(() => {
        console.log(
            "[SubCategories] State change - editingCategory:",
            editingCategory
                ? { id: editingCategory._id, name: editingCategory.name }
                : null,
        );
    }, [editingCategory]);
    ...
    useEffect(() => {
        console.log(
            "[SubCategories] State change - sortField:",
            sortField,
            "sortDirection:",
            sortDirection,
        );
    ...
    useEffect(() => {
        console.log(
            "[SubCategories] State change - searchTerm:",
            searchTerm,
            "filterCategory:",
            filterCategory,
            "filterStatus:",
    ...
    useEffect(() => {
        console.log(
            "[SubCategories] State change - showAdvancedSearch:",
            showAdvancedSearch,
        );
    }, [showAdvancedSearch]);
    ...
    const fetchSubCategories = async () => {
        ...
        try {
            ...
            console.log(
                "[SubCategories] fetchSubCategories - Request params:",
                requestParams,
            );

            const response =
                await adminServices.productCatalog.getCategories(requestParams);
            console.log(
                "[SubCategories] fetchSubCategories - API Response:",
                response,
            );

            if (response.status === "success") {
                // Filter to only show sub-categories (those with parent_id)
                const subCats = response.data.categories.filter(
                    (cat) => cat.parent_id,
                );
                console.log(
                    "[SubCategories] fetchSubCategories - Filtered sub-categories:",
                    subCats.length,
                    subCats,
                );
                setSubCategories(subCats);
                console.log(
                    "[SubCategories] fetchSubCategories - State updated with",
                    subCats.length,
                    "sub-categories",
                );
            } else {
                console.error(
                    "[SubCategories] fetchSubCategories - API returned error:",
                    response.message,
                );
            ...
            console.error(
                "[SubCategories] fetchSubCategories - Exception caught:",
                err,
            );
            console.error(
                "[SubCategories] fetchSubCategories - Error details:",
                {
                    message: err.message,
                    stack: err.stack,
                    name: err.name,
            ...
            setLoading(false);
            console.log(
                "[SubCategories] fetchSubCategories - Loading set to false",
            );
        }
    };
    ...
    const fetchCategories = async () => {
        ...
        try {
            ...
            console.log(
                "[SubCategories] fetchCategories - Request params:",
                requestParams,
            );

            const response =
                await adminServices.productCatalog.getRootCategories(
                    requestParams,
                );
            console.log(
                "[SubCategories] fetchCategories - API Response:",
                response,
            );
            ...
            if (response.status === "success") {
                ...
                console.log(
                    "[SubCategories] fetchCategories - Fetched",
                ...
                console.log(
                    "[SubCategories] fetchCategories - State updated with",
                    categoriesList.length,
                    "categories",
                );
            } else {
                console.error(
                    "[SubCategories] fetchCategories - API returned error:",
                    response.message,
                );
            }
        } catch (err) {
            console.error(
                "[SubCategories] fetchCategories - Exception caught:",
                err,
            );
    ...
    const handleAdd = () => {
        console.log(
            "[SubCategories] handleAdd - User clicked Add Sub-Category button",
        );
        setEditingCategory(null);
        setParentCategory(null);
        setShowForm(true);
        console.log(
            "[SubCategories] handleAdd - Form state updated: showForm=true, editingCategory=null, parentCategory=null",
        );
    };

    const handleEdit = (subCategory) => {
        console.log(
            "[SubCategories] handleEdit - User clicked Edit button for sub-category:",
            {
                id: subCategory._id,
        ...
        setShowForm(true);
        console.log(
            "[SubCategories] handleEdit - Form state updated: showForm=true, editingCategory set, parentCategory set",
        );
    };

    const handleDelete = async (subCategoryId) => {
        console.log(
            "[SubCategories] handleDelete - User clicked Delete button for sub-category:",
            subCategoryId,
        );
        console.log(
            "[SubCategories] handleDelete - ID type:",
        ...
        if (!normalizedId) {
            console.error(
                "[SubCategories] handleDelete - Failed to normalize ID:",
                subCategoryId,
            );
        ...
        if (!objectIdPattern.test(normalizedId)) {
            console.error(
                "[SubCategories] handleDelete - Invalid ObjectId format:",
                normalizedId,
            );
        ...
        console.log(
            "[SubCategories] handleDelete - Normalized ID:",
            normalizedId,
            "(original:",
            subCategoryId,
            ")",
        ...
        if (
            ...
            console.log(
                "[SubCategories] handleDelete - User cancelled deletion",
            );
            return;
        }

        console.log(
            "[SubCategories] handleDelete - User confirmed deletion, starting API call",
        );
        try {
            const adminServices = getAdminServices();
            console.log(
                "[SubCategories] handleDelete - Calling deleteCategory API with normalized ID:",
                normalizedId,
            );

            const response =
                await adminServices.productCatalog.deleteCategory(normalizedId);
            console.log(
                "[SubCategories] handleDelete - API Response:",
                response,
            );

            if (response.status === "success") {
                console.log(
                    "[SubCategories] handleDelete - Deletion successful, refreshing sub-categories list",
                );
                await fetchSubCategories();
                console.log(
                    "[SubCategories] handleDelete - Sub-categories list refreshed",
                );
            } else {
                console.error(
                    "[SubCategories] handleDelete - API returned error:",
                    response.message,
                );
            ...
            console.error(
                "[SubCategories] handleDelete - Exception caught:",
                err,
            );
    ...
    const handleFormSuccess = () => {
        console.log(
            "[SubCategories] handleFormSuccess - Form submission successful",
        );
        setShowForm(false);
        setEditingCategory(null);
        setParentCategory(null);
        console.log(
            "[SubCategories] handleFormSuccess - Form state reset, refreshing data",
        );
        fetchSubCategories();
        fetchCategories();
    };
    ...
    const getCategoryName = (parentId) => {
        ...
        const category = categories.find(
            (cat) => cat._id === parentId || cat._id === parentId._id,
        );
    ...
    const filteredAndSortedSubCategories = useMemo(() => {
        console.log(
            "[SubCategories] filteredAndSortedSubCategories - Recomputing filtered/sorted list",
        );
        console.log(
            "[SubCategories] filteredAndSortedSubCategories - Input data:",
            {
        ...
        if (searchTerm) {
            ...
            filtered = filtered.filter(
                (subCat) =>
                    ...
                    getCategoryName(subCat.parent_id)
                        ?.toLowerCase()
                        .includes(searchLower) ||
                    subCat.description?.toLowerCase().includes(searchLower),
            );
            console.log(
                "[SubCategories] filteredAndSortedSubCategories - After search filter:",
                {
                    before: beforeCount,
        ...
        if (filterCategory) {
            ...
            filtered = filtered.filter((subCat) => {
                ...
                return (
                    ...
                    parentId?.toString() === filterCategory
                );
            });
            console.log(
                "[SubCategories] filteredAndSortedSubCategories - After category filter:",
                {
                    before: beforeCount,
                    after: filtered.length,
                    filterCategory,
        ...
        if (filterStatus !== "") {
            ...
            filtered = filtered.filter(
                (subCat) => subCat.is_active === isActive,
            );
            console.log(
                "[SubCategories] filteredAndSortedSubCategories - After status filter:",
                {
                    before: beforeCount,
                    after: filtered.length,
                    filterStatus,
        ...
        console.log(
            "[SubCategories] filteredAndSortedSubCategories - After sorting:",
            {
                sortField,
                sortDirection,
        ...
        console.log(
            "[SubCategories] filteredAndSortedSubCategories - Final result:",
            {
    ...
    const handleSort = (field) => {
        console.log(
            "[SubCategories] handleSort - User clicked sort on field:",
            field,
        );
        if (sortField === field) {
            const newDirection = sortDirection === "asc" ? "desc" : "asc";
            console.log(
                "[SubCategories] handleSort - Toggling sort direction from",
                sortDirection,
                "to",
                newDirection,
            );
            ...
            console.log(
                "[SubCategories] handleSort - Changing sort field from",
                sortField,
                "to",
                field,
                "with direction: asc",
    ...
    const handleAddProduct = (subCategory, e) => {
        console.log(
            "[SubCategories] handleAddProduct - User clicked Add Product button for sub-category:",
            {
                id: subCategory._id,
                name: subCategory.name,
            },
        ...
        console.log(
            "[SubCategories] handleAddProduct - Navigating to /admin/products with state:",
            navigationState,
        );
    ...
    const handleViewProducts = (subCategory, e) => {
        console.log(
            "[SubCategories] handleViewProducts - User clicked View Products button for sub-category:",
            {
                id: subCategory._id,
                name: subCategory.name,
            },
        ...
        console.log(
            "[SubCategories] handleViewProducts - Navigating to /admin/products with state:",
            navigationState,
        );
        navigate("/admin/products", { state: navigationState });
    };
    ...
    const handleClearFilters = () => {
        console.log(
            "[SubCategories] handleClearFilters - User clicked Clear Filters button",
        );
        console.log(
            "[SubCategories] handleClearFilters - Current filter values:",
            {
                searchTerm,
                filterCategory,
                filterStatus,
        ...
        <div className="p-6">
            ...
            <div className="mb-6 space-y-4">
                ...
                <div className="flex items-center space-x-4">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                console.log(
                                    "[SubCategories] Search input changed:",
                                    {
                                        previous: searchTerm,
                                        new: newValue,
                    ...
                    <button
                        onClick={() => {
                            ...
                            console.log(
                                "[SubCategories] Advanced search toggle clicked:",
                                {
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        const newValue = e.target.value;
                                        console.log(
                                            "[SubCategories] Category filter changed:",
                                            {
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        const newValue = e.target.value;
                                        console.log(
                                            "[SubCategories] Status filter changed:",
                                            {
                ...
                <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
                    <span>
                        Showing {filteredAndSortedSubCategories.length} of{" "}
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {loading ? (
                                ...
                                filteredAndSortedSubCategories.map(
                                    (subCategory) => (
                                        <tr
                                            key={subCategory._id}
